...
public class TicketBookingApp {
	...
	private static void exercise2(PrintStream out) {
		...
		*/
        Scanner file = null;
        try{
            file = new Scanner(new FileReader("ticket_bookings.txt"));
        }catch(IOException e){
        ...
        while (file.hasNextLine()){
            ...
            if (line.startsWith("##")) continue;
                ...
                for (int i; i < 7; i++){
                    String[] parts = line.split(" "); /*divide em Booking=1001 e 17 */
                    String[] parts1 = parts[0].split("="); /*divide em Booking e 1001 */
                    if (bookTickets(parts1[1], parts[0]) != -1) {
