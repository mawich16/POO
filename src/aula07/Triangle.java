...
public class Triangle extends Shape {
    ...
    public Triangle(double side1Value, double side2Value, double side3Value, String color) {
        super(color);
        if (side1Value <= 0) {
    ...
    public String toString() {
        return "Triangle: side1 = " + side1 + ", side2 = " + side2 + ", side3 = " + side3 + ", area = " + Area() + ", perimeter = " + Perimeter() + super.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return super.equals(obj) && triangle.side1 == this.side1 && triangle.side2 == this.side2 && triangle.side3 == this.side3;
    }
